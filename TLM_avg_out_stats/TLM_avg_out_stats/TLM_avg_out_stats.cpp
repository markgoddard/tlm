...
InputFlags InputData = {{true,true}, {false,true}, {false,true}, {false,true}};
PLParams PathLossParameters = {NONE,0,0,0,0,0,0,0.2,0.2,0.2};
...
bool DefaultStatsFilename = true;
...
int main(int argc, char *argv[])
{
	...
	if (Successful == true) {
		...
		// Print the statistics to a text file
